...
var ApiModule = function () {
    ...
    var _classThis;
    var ApiModule = _classThis = /** @class */ (function () {
        function ApiModule_1(parentModule, http) {
            if (parentModule) {
        ...
        ApiModule_1.forRoot = function (configurationFactory) {
            return {
                ngModule: ApiModule,
    ...
    __setFunctionName(_classThis, "ApiModule");
    (function () {
