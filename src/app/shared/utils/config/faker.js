...
function generateAndSaveUsers(numberOfUsers) {
    return __awaiter(this, void 0, void 0, function () {
        function generateMovie() {
            test.movieApplicationControllerHandleCreateAndPublishMovie({
                title: faker_1.faker.name.firstName(),
                director: faker_1.faker.name.lastName(),
                poster: faker_1.faker.image.cats(289, 420, true),
            });
        }
        var test, i, user;
        return __generator(this, function (_a) {
            (0, core_1.inject)(client_1.MovieService);
            ...
            for (i = 0; i < numberOfUsers; i++) {
                ...
                console.log("Generated user: ".concat(JSON.stringify(user))); // Log generated user data
            }
            return [2 /*return*/];
        });
    });
